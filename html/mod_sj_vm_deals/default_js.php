...
jQuery(document).ready(function ($) {
	...
	$("#<?php echo $module_id;?> .owl-carousel .item").each(function(){
		...
		$(this).find('.item-deals').html('<div class="sj_deals_cd_day"><span>'+(html_day)+'<span>Days</span></div><div class="sj_deals_cd_day"><span>'+html_hours+'</span><span>Hours</span></div><div class="sj_deals_cd_day"><span>'+html_minus+'</span><span>Mins</span></div><div class="sj_deals_cd_day"><span>'+html_seconds+'</span><span>Secs</span></div>');
		i++;
		}
	});
		...
		$("#<?php echo $module_id;?> .sj_vm_deals_first_product .item").find('.item-deals').html('<div class="sj_deals_cd_day"><span>'+(html_day)+'<span>Days</span></div><div class="sj_deals_cd_day"><span>'+html_hours+'</span><span>Hours</span></div><div class="sj_deals_cd_day"><span>'+html_minus+'</span><span>Mins</span></div><div class="sj_deals_cd_day"><span>'+html_seconds+'</span><span>Secs</span></div>');
		}
	setInterval(function(){
		...
		$("#<?php echo $module_id;?> .owl-carousel .item").each(function(){
			...
			var html_minus = parseInt((parseInt(array_time[i]) - parseInt(time_now) - html_day*days - html_hours*hours)/minutes);
			var html_seconds =  parseInt((parseInt(array_time[i]) - parseInt(time_now) - html_day*days - html_hours*hours - html_minus*minutes)/1000);
			$(this).find('.item-deals').find('.sj_deals_cd_day').eq(0).html('<span>' + html_day + '</span><span>Days</span>');
			$(this).find('.item-deals').find('.sj_deals_cd_day').eq(1).html('<span>' + html_hours + '</span><span>Hours</span>');
			$(this).find('.item-deals').find('.sj_deals_cd_day').eq(2).html('<span>' + html_minus + '</span><span>Mins</span>');
			$(this).find('.item-deals').find('.sj_deals_cd_day').eq(3).html('<span>' + html_seconds + '</span><span>Secs</span>');
			i++;
		});
			var minutes = 1000 * 60;
			var hours = minutes * 60;
			...
			var html_minus = parseInt((parseInt(mk_time_first_product) - parseInt(time_now) - html_day*days - html_hours*hours)/minutes);
			var html_seconds =  parseInt((parseInt(mk_time_first_product) - parseInt(time_now) - html_day*days - html_hours*hours - html_minus*minutes)/1000);
			$("#<?php echo $module_id;?> .sj_vm_deals_first_product .item").find('.sj_deals_cd_day').eq(0).html('<span>' + html_day + '</span><span>Days</span>');
			$("#<?php echo $module_id;?> .sj_vm_deals_first_product .item").find('.sj_deals_cd_day').eq(1).html('<span>' + html_hours + '</span><span>Hours</span>');
			$("#<?php echo $module_id;?> .sj_vm_deals_first_product .item").find('.sj_deals_cd_day').eq(2).html('<span>' + html_minus + '</span><span>Mins</span>');
			$("#<?php echo $module_id;?> .sj_vm_deals_first_product .item").find('.sj_deals_cd_day').eq(3).html('<span>' + html_seconds + '</span><span>Secs</span>');
	}, 1000);
	  <?php }?>
	  setTimeout(function(){
